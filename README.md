...
평가 스크립트에서 사용하는 6개 기준과, E2E Judge 결과 테이블에서 사용하는 5개 컬럼은 명칭이 다소 다르다. 아래에 대응 관계를 정리한다.

**6개 평가 기준 (eval_llm_judge.py 기준):**
...
**E2E Judge 결과 테이블 컬럼 (5개):**

| 결과 컬럼 | 대응하는 평가 기준 |
|-----------|-----------------|
| 캐릭터 일관성 | 캐릭터 일관성 |
| 서사 품질 | 서사 품질 |
| 맥락 연속성 | 세계관 정합성 + 응답 관련성 (통합 지표) |
| 몰입감 | 유저 자율성 + 플레이어 주권 (통합 지표) |
| 창의성 | 별도 창의성 평가 (6개 기준에 미포함) |
