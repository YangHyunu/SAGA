...
- **LLM-as-a-Judge** [[5]](#ref-5) -- LLM을 평가자로 사용하는 방법론. SAGA는 LOCOMO 벤치마크에서 LLM-as-Judge로 메모리 시스템 효과를 정량 평가한다.
...
- 메모리 회상 효과: LOCOMO 벤치마크 Judge +54% (2.02→3.12), multi-hop 4.71/5
